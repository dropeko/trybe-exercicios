...
- Use o comando: `git clone git@github.com:tryber/sd-029-b-exercise-frontend-content`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-029-b-exercise-frontend-content`
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu exercício
  ...
  - Exemplo: `git checkout -b joaozinho-sd-029-b-exercise-frontend-content`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-029-b-exercise-frontend-content`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-029-b-exercise-frontend-content/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-029-b-exercise-frontend-content/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  [FORMULÁRIO DE AVALIAÇÃO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH29-B&template=betrybe/sd-029-b-exercise-frontend-content)
